function checkQuestionResult(chosenQuestionNumber, transported, countdown, choice) {
    ...
    const isTransportable = questions[chosenQuestionNumber].transportable;
    ...
    // 3. It's the first attempt but the question is NOT transportable (wrong or timeout).
    if (isCorrect || transported === 1 || !isTransportable) {
        stopTimer(countdown);
